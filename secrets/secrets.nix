...
let
  ...
  brouwerSys = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKzxQgondgEYcLpcPdJLrTdNgZ2gznOHCAxMdaceTUT1";
...
in
{
  ...
  "freshrssPwd.age".publicKeys = [ shanonSys dsa ];
  "freshrssDbPwd.age".publicKeys = [ shanonSys dsa ];
}
